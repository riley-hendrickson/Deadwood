...
public class SetTrailorView
{
    ...
    public SetTrailorView(JFrame parentContainer, ISet set, GameController controller)
    {
    ...
    public void drawSet()
    {
        ...
        cardPanel.addMouseListener(new TrailorButtonListener()); // uncomment this to list clicks on this set
    }
    private class TrailorButtonListener implements MouseListener
    {
